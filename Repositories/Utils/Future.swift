...
public final class Future<T, E: Error> {
    ...
    @discardableResult
    public func then(on queue: DispatchQueue,
                     block: @escaping ((Value) -> Void)) -> Future<Value, Error> {
    ...
    @discardableResult
    public func `catch`(on queue: DispatchQueue,
                        block: @escaping ((Error) -> Void)) -> Future<Value, Error> {
